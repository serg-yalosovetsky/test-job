...
def redirecter(order:dict):
    ...
    if currency == 'EUR':
        ...
        redirect_url = 'https://wallet.piastrix.com/ru/bill/pay/WtvoXPzcphd'
        method_order = 'bill'
    elif currency == 'RUB':
        redirect_url = 'https://payeer.com/api/merchant/process.php'
        method_order = 'invoice'
    request_param =  adder_params(method_order, order)
    request_param['redirect_url'] = redirect_url
    request_param['method_order'] = method_order.capitalize()
